...
namespace EMS.Entities
{
    ...
    public class TbPaymentOther : Entity<Guid>
    {
        public string OtherId { get; set; } // OtherID (Primary key) (length: 50)
        public string PaymentApplyId { get; set; } // PaymentApplyID (length: 50)
        public int? Sort { get; set; } // Sort
        public string Overview { get; set; } // Overview (length: 200)
 ...
 //public DateTime DeleterUserId { get; set; }
        ...
        /// <summary>
        /// Parent TbPaymentApply pointed by [TB_Payment_Other].([PaymentApplyId]) (RefTB_Payment_Apply248)
        /// </summary>
        public virtual TbPaymentApply TbPaymentApply { get; set; } // RefTB_Payment_Apply248
    }
