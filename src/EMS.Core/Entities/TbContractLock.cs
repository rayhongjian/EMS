...
namespace EMS.Entities
{
    ...
    // The table 'TB_Contract_Lock' is not usable by entity framework because it
    // does not have a primary key. It is listed here for completeness.
    // TB_Contract_Lock
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class TbContractLock : Entity<Guid>
    {
        ...
        public string Operating { get; set; } // Operating (length: 10)
