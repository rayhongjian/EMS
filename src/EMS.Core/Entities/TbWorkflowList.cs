...
namespace EMS.Entities
{
    ...
    public class TbWorkflowList : Entity<Guid>
    {
        public int WorkFlowId { get; set; } // WorkFlowID (Primary key)
        public string WorkflowCode { get; set; } // WorkflowCode (length: 50)
        public string WorkflowName { get; set; } // WorkflowName (length: 50)
